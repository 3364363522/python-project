...
def calculate_accuracy():
    ...
    print("-" * 50)
    print(f"Total Actual Eliminated Contestants (Sum of n): {total_n}")
    print(f"Total Correctly Predicted Contestants (Sum of m): {total_m}")
    print(f"Overall Prediction Accuracy (Total Correct / Total Eliminated): {weighted_accuracy:.2%}")
    print("-" * 50)
    
    print("\nSample Results (First 15 rows):")
    # 展示新的 prediction_status 列
